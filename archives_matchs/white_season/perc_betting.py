...
white_data=pd.read_csv('real/E01516_real.csv')
...
for j in [ 53]:
    ...
    for i in range(n):
            ...
            if ypredict[s]==1: #on predit win de l'equipe home
                if 1.3<x_white[s].tolist()[0][1]<3:
                    ...
                    if ypredict[s] == y_white[s]:
                        ...
                        capital+=(0.02*capital)*(x_white[s].tolist()[0][1]-1) 
                        #c_reu +=1;
                    else:
                        gain-= 1
                ...
                if 1.3<x_white[s].tolist()[0][3]<3:
                    ...
                    if ypredict[s] == y_white[s]:
                        ...
                        capital+=(0.02*capital)*(x_white[s].tolist()[0][3]-1) 
                        #c_reu +=1;
                    else:
        ...
        gain_moy += gain
        capital_moy += capital
    print(j, c_reu/n*100, "% positif | gain moyen :", round(gain_moy/n, 2), " | % de réussite : ",  round(1-(err_moy/n),2),"| nb de paris :", compteur, "| capital moyen : ", round(capital_moy/n,2))
